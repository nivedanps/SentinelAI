...
export const mockCriticalIncidents: CriticalIncidentRow[] = [
  {
    id: 'INC-1042',
    ...
    affected_pop: 3200,
    risk: 'HIGH',
    resources_required: 'Rescue Boats',
    status: 'IN_PROGRESS',
    created: '14:30 Today',
  },
  {
    ...
    affected_pop: 4500,
    risk: 'HIGH',
    resources_required: 'HAZMAT Foam Tenders',
    status: 'IN_PROGRESS',
    created: '13:15 Today',
  },
  {
    ...
    affected_pop: 1800,
    risk: 'HIGH',
    resources_required: 'Heavy Earthmovers',
    status: 'VERIFIED',
    created: '12:00 Today',
  },
  {
    ...
    affected_pop: 2980,
    risk: 'HIGH',
    resources_required: 'Geotechnical Crew',
    status: 'REPORTED',
    created: '10:45 Today',
  },
];

export const mockOperationalAnalytics: OperationalAnalyticsData = {
  ...
  critical_incidents: mockCriticalIncidents,
};

export async function fetchOperationalAnalytics(
  filters?: Partial<AnalyticsFilterState>
): Promise<OperationalAnalyticsData> {
  try {
    const { data } = await apiClient.get<OperationalAnalyticsData>('/analytics/overview', {
      params: {
        date_range: filters?.dateRange || '24h',
        disaster_type: filters?.disasterType || 'ALL',
    ...
    return mockOperationalAnalytics;
  }
}
